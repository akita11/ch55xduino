...
__code uint8_t CfgDesc[] = {
    ...
    0x80, 0x64, // Configuration descriptor (2 interfaces)
    ...
    0x04, // CDC control description, 1 endpoint
    ...
    0x05, 0x24, 0x06, 0x00, 0x01, // Union Functional Descriptor, Communication
                                  // class interface 0, Data Class Interface 1
    ...
    0x04,                                     // Data Class Interface descriptor
...
__code uint8_t SerDes[] = { // Serial String Descriptor
    0x0E, 0x03, 'C',  0x00, 'H',  0x00, '_',
    0x00, 'R',  0x00, 'b',  0x00, 't',  0x00};
__code uint16_t SerDesLen = sizeof(SerDes);
__code uint8_t Prod_Des[] = { // Produce String Descriptor
    0x18, 0x03, 'C', 0x00, 'H', 0x00, '5', 0x00, '5', 0x00, 'x', 0x00,
    'R',  0x00, 'e', 0x00, 'b', 0x00, 'o', 0x00, 'o', 0x00, 't', 0x00};
